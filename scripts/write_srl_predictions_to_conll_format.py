...
def main(serialization_directory, device, data, prefix):
    """
    ...
    model_predictions = []
    for batch in tqdm.tqdm(iterator(dataset, num_epochs=1, shuffle=False, for_training=True, cuda_device=device)):
...
if __name__ == "__main__":
    ...
    main(args.path, args.device, args.data, args.prefix)
