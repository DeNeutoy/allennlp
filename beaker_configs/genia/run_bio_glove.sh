...
python scripts/ai2-internal/run_with_beaker.py $CONFIG_PATH/baseline.json --source "ds_33fmprd6uv1g:/glove" --source "genia-ptb:/genia-ptb" \
                                                            --memory 10GB --gpu_count 1 --desc "baseline, bio glove only"
...
python scripts/ai2-internal/run_with_beaker.py $CONFIG_PATH/baseline_elmo_glove.json --source "ds_33fmprd6uv1g:/glove" --source "genia-ptb:/genia-ptb" \
                                                             --source "$ELMO:/elmo" --memory 10GB --gpu_count 1 --desc "$NAME with bio glove" \
