...
from Tagger.ops.layers import layer_norm, linear, smoothed_softmax_cross_entropy_with_logits
from Tagger.ops.attention import multihead_attention, attention_bias, add_timing_signal
            ...
            with tf.variable_scope("layer_%d" % layer):
                ...
                with tf.variable_scope("self_attention"):
                    y = multihead_attention(
                        ...
                        memory=None,
                        bias=attn_bias,
                        key_size=params.attention_key_channels or params.hidden_size,
                        value_size=params.attention_value_channels or params.hidden_size,
                        output_size=params.hidden_size,
                        num_heads=params.num_heads,
                        keep_prob=1.0 - params.attention_dropout,
...
def deepatt_model(features, mode, params):
    ...
    # label smoothing
    ce = smoothed_softmax_cross_entropy_with_logits(
        logits=logits,
        labels=labels,
